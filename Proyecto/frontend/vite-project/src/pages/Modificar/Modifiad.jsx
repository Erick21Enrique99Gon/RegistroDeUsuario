...
import { modificarUsuario, listarPaises } from '../../services/AdministracionServices';
    ...
    useEffect(() => {
        const fetchUsuario = async () => {
            try {
                ...
                // Mapear datos de cookie a formData (incluye todos los campos)
                setFormData({
                    id: usuarioCookie.id,
                        ...
                        <div className="checkbox-group">
                            <label>
                                <input
                                    type="checkbox"
                                    name="administrador"
                                    checked={formData.administrador || false}
                        ...
                        <div className="checkbox-group">
                            <label>
                                <input
                                    type="checkbox"
                                    name="ciudadano"
                                    checked={formData.ciudadano || false}
                                    onChange={handleCheckboxChange}
                                />
                                Ciudadano
                            </label>
